import aiida_QECpWorkChain.workflow2 as wf2
...
wg=wf2.build_and_test(code=Code.get_from_string('cp@localhost'),pseudo_family='SSSP/1.3/PBE/efficiency',structure=aiida_structure_IV,ecutwfc=42.0,resources={'resources':{'num_machines':1,'num_mpiprocs_per_machine':1},'wallclock':60},additional_parameters={
    'SYSTEM': {
        'nr1b': 5,
        'nr2b': 5,
        'nr3b': 5,
