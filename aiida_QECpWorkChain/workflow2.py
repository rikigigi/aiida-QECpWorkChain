...
@aiida_workgraph.task.graph_builder(
    outputs=[{"name": "output", "from": "context.calculation"}]
)
def build_and_test(code : aiida.orm.Code,pseudo_family : str,
                            structure : aiida.orm.StructureData,
                            ecutwfc : float,
                            resources : dict,
                            additional_parameters : dict,
