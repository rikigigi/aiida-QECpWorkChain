...
Check version number in setup.json and aiida_QECpWorkChain/__init__.py and make sure
they match.
"""
...
import aiida_QECpWorkChain  # pylint: disable=wrong-import-position
version = aiida_QECpWorkChain.__version__
